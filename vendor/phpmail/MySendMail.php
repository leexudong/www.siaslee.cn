...
* @example
* $mail = new MySendMail();
* $mail->setServer("smtp@phpbryant.com", "phpbryant", "LIUhao0816."); 设置smtp服务器
* $mail->setFrom("bobo@phpbryant.com"); 设置发件人 
* $mail->setReceiver("1359993014@qq.com"); 设置收件人，多个收件人，调用多次
