...
$("#addafl").click(function(){
	if($("#flinputs .row1_box_half").length > 29){
		...
		$(this).parent().prev().append("<div class='row1_box_half'><div class='suggestionsBox suggestions' style='display:none;'><ul class='suggestionList autoSuggestionsList' ></ul></div><div class='input_text_item1'><input class='inputtext_scname' value='' type='text' placeholder='请填写辅料名称' defaultval='请填写辅料名称' autocomplete='off' href='/ajax/shicai_rel.php'></div><div class='input_text_item2'><input type='text' placeholder='请填写用量'></div><span class='delsc'></span></div> "); 
	}
...
function relist_zl(){
	...
	for(var i = 0;i<len;i++){
		if(i%2 == 0){
			$(list[i]).attr("name","zlsc[]");
		}else{
			$(list[i]).attr("name","zlyl[]");
		}
	}
}
function relist_fl(){
	...
	for(var i = 0;i<len;i++){
		if(i%2 == 0){
			$(list[i]).attr("name","flsc[]");
		}else{
			$(list[i]).attr("name","flyl[]");
		}
	}
}
function aca_tips(){
...
function addScInStep(ele){
	...
	$.each(add_zl,function(){
		...
		var txt = "<div class='row1_box_half'><div class='input_text_item1'><input name='zlsc[]' type='text' placeholder='请填写食材名称' value="+$(this).find("input").first().val()+"></div><div class='input_text_item2'><input name='zlyl[]' type='text' placeholder='请填写用量' value="+$(this).find("input").last().val()+"></div><span class='delsc'></span></div>"
		$("#zlinputs").append(txt);
	});
	...
	$.each(add_fl,function(){
		...
		var txt = "<div class='row1_box_half'><div class='input_text_item1'><input name='flsc[]' type='text' placeholder='请填写食材名称' value="+$(this).find("input").first().val()+"></div><div class='input_text_item2'><input name='flyl[]' type='text' placeholder='请填写用量' value="+$(this).find("input").last().val()+"></div><span class='delsc'></span></div>"
		$("#flinputs").append(txt);
	});
